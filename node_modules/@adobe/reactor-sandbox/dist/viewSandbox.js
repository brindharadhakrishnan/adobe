parcelRequire=function(e,r,t,n){var i,o="function"==typeof parcelRequire&&parcelRequire,u="function"==typeof require&&require;function f(t,n){if(!r[t]){if(!e[t]){var i="function"==typeof parcelRequire&&parcelRequire;if(!n&&i)return i(t,!0);if(o)return o(t,!0);if(u&&"string"==typeof t)return u(t);var c=new Error("Cannot find module '"+t+"'");throw c.code="MODULE_NOT_FOUND",c}p.resolve=function(r){return e[t][1][r]||r},p.cache={};var l=r[t]=new f.Module(t);e[t][0].call(l.exports,p,l,l.exports,this)}return r[t].exports;function p(e){return f(p.resolve(e))}}f.isParcelRequire=!0,f.Module=function(e){this.id=e,this.bundle=f,this.exports={}},f.modules=e,f.cache=r,f.parent=o,f.register=function(r,t){e[r]=[function(e,r){r.exports=t},{}]};for(var c=0;c<t.length;c++)try{f(t[c])}catch(e){i||(i=e)}if(t.length){var l=f(t[t.length-1]);"object"==typeof exports&&"undefined"!=typeof module?module.exports=l:"function"==typeof define&&define.amd?define(function(){return l}):n&&(this[n]=l)}if(parcelRequire=f,i)throw i;return f}({"coqt":[function(require,module,exports) {
var define;
...
},{}],"9iI9":[function(require,module,exports) {
...
},{"./util":"9iI9"}],"uX8w":[function(require,module,exports) {
...
},{"uri-js":"coqt","fast-deep-equal":"HSgd","./util":"9iI9","./schema_obj":"wMvT","json-schema-traverse":"uX8w"}],"vvI2":[function(require,module,exports) {
...
},{}],"M/Ss":[function(require,module,exports) {
...
},{"./resolve":"T7Bo","./util":"9iI9","./error_classes":"vvI2","fast-json-stable-stringify":"hkDR","../dotjs/validate":"mFX2","fast-deep-equal":"HSgd"}],"sdiS":[function(require,module,exports) {
...
},{"./util":"9iI9"}],"wQKR":[function(require,module,exports) {
...
},{}],"30Z8":[function(require,module,exports) {
...
},{}],"+y9c":[function(require,module,exports) {
...
},{}],"Y+8i":[function(require,module,exports) {
...
},{}],"1ITY":[function(require,module,exports) {
...
},{"./ref":"wQKR","./allOf":"ka0E","./anyOf":"30Z8","./comment":"h3nU","./const":"+y9c","./contains":"bQT3","./dependencies":"n6gK","./enum":"SsdN","./format":"fVUx","./if":"y9FO","./items":"iBDe","./_limit":"QHAN","./_limitItems":"RtVP","./_limitLength":"Y+8i","./_limitProperties":"XsSN","./multipleOf":"f6NZ","./not":"F4ou","./oneOf":"nvKM","./pattern":"fNq0","./properties":"rWWh","./propertyNames":"mz5K","./required":"NjGh","./uniqueItems":"1ITY","./validate":"mFX2"}],"VHjW":[function(require,module,exports) {
...
},{"../dotjs":"Zaki","./util":"9iI9"}],"l6Yo":[function(require,module,exports) {
...
},{}],"Q9+S":[function(require,module,exports) {
...
},{}],"3TbV":[function(require,module,exports) {
...
},{}],"BRd3":[function(require,module,exports) {
"use strict";var e=/^[a-z_$][a-z0-9_$-]*$/i,t=require("./dotjs/custom"),r=require("./refs/json-schema-draft-07.json");module.exports={add:a,get:o,remove:s,validate:n};var i={definitions:{simpleTypes:r.definitions.simpleTypes},type:"object",dependencies:{schema:["validate"],$data:["validate"],statements:["inline"],valid:{not:{required:["macro"]}}},properties:{type:r.properties.type,schema:{type:"boolean"},statements:{type:"boolean"},dependencies:{type:"array",items:{type:"string"}},metaSchema:{type:"object"},modifying:{type:"boolean"},valid:{type:"boolean"},$data:{type:"boolean"},async:{type:"boolean"},errors:{anyOf:[{type:"boolean"},{const:"full"}]}}};function a(r,i){var a=this.RULES;if(a.keywords[r])throw new Error("Keyword "+r+" is already defined");if(!e.test(r))throw new Error("Keyword "+r+" is not a valid identifier");if(i){this.validateKeyword(i,!0);var o=i.type;if(Array.isArray(o))for(var s=0;s<o.length;s++)d(r,o[s],i);else d(r,o,i);var n=i.metaSchema;n&&(i.$data&&this._opts.$data&&(n={anyOf:[n,{$ref:"https://raw.githubusercontent.com/epoberezkin/ajv/master/lib/refs/data.json#"}]}),i.validateSchema=this.compile(n,!0))}function d(e,r,i){for(var o,s=0;s<a.length;s++){var n=a[s];if(n.type==r){o=n;break}}o||(o={type:r,rules:[]},a.push(o));var d={keyword:e,definition:i,custom:!0,code:t,implements:i.implements};o.rules.push(d),a.custom[e]=d}return a.keywords[r]=a.all[r]=!0,this}function o(e){var t=this.RULES.custom[e];return t?t.definition:this.RULES.keywords[e]||!1}function s(e){var t=this.RULES;delete t.keywords[e],delete t.all[e],delete t.custom[e];for(var r=0;r<t.length;r++)for(var i=t[r].rules,a=0;a<i.length;a++)if(i[a].keyword==e){i.splice(a,1);break}return this}function n(e,t){n.errors=null;var r=this._validateKeyword=this._validateKeyword||this.compile(i,!0);if(r(e))return!0;if(n.errors=r.errors,t)throw new Error("custom keyword definition is invalid: "+this.errorsText(r.errors));return!1}
},{"./dotjs/custom":"bd1B","./refs/json-schema-draft-07.json":"3TbV"}],"vZT2":[function(require,module,exports) {
...
},{"./compile":"M/Ss","./compile/resolve":"T7Bo","./cache":"sdiS","./compile/schema_obj":"wMvT","fast-json-stable-stringify":"hkDR","./compile/formats":"DtrD","./compile/rules":"VHjW","./data":"l6Yo","./compile/util":"9iI9","./compile/async":"Q9+S","./keyword":"BRd3","./compile/error_classes":"vvI2","./refs/data.json":"vZT2","./refs/json-schema-draft-07.json":"3TbV"}],"zDnq":[function(require,module,exports) {
...
},{}],"l7uD":[function(require,module,exports) {
...
},{}],"XEIX":[function(require,module,exports) {
...
},{"./lib/keys.js":"l7uD","./lib/is_arguments.js":"XEIX"}],"oE8C":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.DATA_CLONE_ERROR=exports.MESSAGE=exports.REJECTED=exports.FULFILLED=exports.REPLY=exports.CALL=exports.HANDSHAKE_REPLY=exports.HANDSHAKE=void 0;var e="handshake";exports.HANDSHAKE=e;var r="handshake-reply";exports.HANDSHAKE_REPLY=r;var E="call";exports.CALL=E;var s="reply";exports.REPLY=s;var t="fulfilled";exports.FULFILLED=t;var o="rejected";exports.REJECTED=o;var p="message";exports.MESSAGE=p;var a="DataCloneError";exports.DATA_CLONE_ERROR=a;
},{}],"dJki":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.ERR_NO_IFRAME_SRC=exports.ERR_NOT_IN_IFRAME=exports.ERR_CONNECTION_TIMEOUT=exports.ERR_CONNECTION_DESTROYED=void 0;var e="ConnectionDestroyed";exports.ERR_CONNECTION_DESTROYED=e;var R="ConnectionTimeout";exports.ERR_CONNECTION_TIMEOUT=R;var E="NotInIframe";exports.ERR_NOT_IN_IFRAME=E;var _="NoIframeSrc";exports.ERR_NO_IFRAME_SRC=_;
},{}],"1j7A":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=function(){var e=[],t=!1;return{destroy:function(){t=!0,e.forEach(function(e){e()})},onDestroy:function(o){t?o():e.push(o)}}};exports.default=e,module.exports=exports.default;
},{}],"Q/di":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t={"http:":"80","https:":"443"},e=/^(https?:|file:)?\/\/([^\/:]+)?(:(\d+))?/,o=["file:","data:"],r=function(r){if(r&&o.find(function(t){return r.startsWith(t)}))return"null";var c,n,a,u=document.location,l=e.exec(r);l?(c=l[1]?l[1]:u.protocol,n=l[2],a=l[4]):(c=u.protocol,n=u.hostname,a=u.port);var s=a&&a!==t[c]?":".concat(a):"";return"".concat(c,"//").concat(n).concat(s)};exports.default=r,module.exports=exports.default;
},{}],"fuGz":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=function(e){return function(){if(e){for(var t,o=arguments.length,r=new Array(o),l=0;l<o;l++)r[l]=arguments[l];(t=console).log.apply(t,["[Penpal]"].concat(r))}}};exports.default=e,module.exports=exports.default;
},{}],"0O2d":[function(require,module,exports) {
...
},{}],"y9tl":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("./constants"),r=require("./errorSerialization"),n=function(n,o,t){var a=n.localName,i=n.local,c=n.remote,s=n.originForSending,l=n.originForReceiving,u=!1;t("".concat(a,": Connecting call receiver"));var d=function(n){if(n.source===c&&n.data.penpal===e.CALL)if(n.origin===l){var i=n.data,d=i.methodName,E=i.args,p=i.id;t("".concat(a,": Received ").concat(d,"() call"));var f=function(n){return function(o){if(t("".concat(a,": Sending ").concat(d,"() reply")),u)t("".concat(a,": Unable to send ").concat(d,"() reply due to destroyed connection"));else{var i={penpal:e.REPLY,id:p,resolution:n,returnValue:o};n===e.REJECTED&&o instanceof Error&&(i.returnValue=(0,r.serializeError)(o),i.returnValueIsError=!0);try{c.postMessage(i,s)}catch(l){throw l.name===e.DATA_CLONE_ERROR&&c.postMessage({penpal:e.REPLY,id:p,resolution:e.REJECTED,returnValue:(0,r.serializeError)(l),returnValueIsError:!0},s),l}}}};new Promise(function(e){return e(o[d].apply(o,E))}).then(f(e.FULFILLED),f(e.REJECTED))}else t("".concat(a," received message from origin ").concat(n.origin," which did not match expected origin ").concat(l))};return i.addEventListener(e.MESSAGE,d),function(){u=!0,i.removeEventListener(e.MESSAGE,d)}};exports.default=n,module.exports=exports.default;
},{"./constants":"oE8C","./errorSerialization":"0O2d"}],"EBIj":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=0,t=function(){return++e};exports.default=t,module.exports=exports.default;
},{}],"u45o":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("./constants"),r=require("./errorCodes"),n=o(require("./generateId")),t=require("./errorSerialization");function o(e){return e&&e.__esModule?e:{default:e}}var a=function(o,a,i,c,d){var u=a.localName,l=a.local,s=a.remote,f=a.originForSending,v=a.originForReceiving,g=!1;d("".concat(u,": Connecting call sender"));return i.reduce(function(o,a){return o[a]=function(o){return function(){for(var a=arguments.length,i=new Array(a),E=0;E<a;E++)i[E]=arguments[E];var p;d("".concat(u,": Sending ").concat(o,"() call"));try{s.closed&&(p=!0)}catch(L){p=!0}if(p&&c(),g){var m=new Error("Unable to send ".concat(o,"() call due ")+"to destroyed connection");throw m.code=r.ERR_CONNECTION_DESTROYED,m}return new Promise(function(r,a){var c=(0,n.default)(),g=function(n){if(n.source===s&&n.data.penpal===e.REPLY&&n.data.id===c)if(n.origin===v){d("".concat(u,": Received ").concat(o,"() reply")),l.removeEventListener(e.MESSAGE,g);var i=n.data.returnValue;n.data.returnValueIsError&&(i=(0,t.deserializeError)(i)),(n.data.resolution===e.FULFILLED?r:a)(i)}else d("".concat(u," received message from origin ").concat(n.origin," which did not match expected origin ").concat(v))};l.addEventListener(e.MESSAGE,g),s.postMessage({penpal:e.CALL,id:c,methodName:o,args:i},f)})}}(a),o},o),function(){g=!0}};exports.default=a,module.exports=exports.default;
},{"./constants":"oE8C","./errorCodes":"dJki","./generateId":"EBIj","./errorSerialization":"0O2d"}],"TAMi":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("./constants"),r=require("./errorCodes"),t=c(require("./createDestructor")),o=c(require("./getOriginFromSrc")),n=c(require("./createLogger")),a=c(require("./connectCallReceiver")),i=c(require("./connectCallSender"));function c(e){return e&&e.__esModule?e:{default:e}}var d=6e4,s=function(c){var s=c.iframe,u=c.methods,l=void 0===u?{}:u,v=c.timeout,f=c.debug,m=(0,n.default)(f),E=window,g=(0,t.default)(),h=g.destroy,p=g.onDestroy;if(!s.src&&!s.srcdoc){var R=new Error("Iframe must have src or srcdoc property defined.");throw R.code=r.ERR_NO_IFRAME_SRC,R}var N=(0,o.default)(s.src),_="null"===N?"*":N;return{promise:new Promise(function(t,o){var n;void 0!==v&&(n=setTimeout(function(){var e=new Error("Connection to child timed out after ".concat(v,"ms"));e.code=r.ERR_CONNECTION_TIMEOUT,o(e),h()},v));var c,u,f={},g=function(r){var o=s.contentWindow;if(r.source===o&&r.data.penpal===e.HANDSHAKE)if(r.origin===N){m("Parent: Received handshake, sending reply"),r.source.postMessage({penpal:e.HANDSHAKE_REPLY,methodNames:Object.keys(l)},_);var d={localName:"Parent",local:E,remote:o,originForSending:_,originForReceiving:N};u&&u(),u=(0,a.default)(d,l,m),p(u),c&&c.forEach(function(e){delete f[e]}),c=r.data.methodNames;var v=(0,i.default)(f,d,c,h,m);p(v),clearTimeout(n),t(f)}else m("Parent received handshake from origin ".concat(r.origin," which did not match expected origin ").concat(N))};E.addEventListener(e.MESSAGE,g),m("Parent: Awaiting handshake");var R=setInterval(function(){document.contains(s)||(clearInterval(R),h())},d);p(function(){E.removeEventListener(e.MESSAGE,g),clearInterval(R);var t=new Error("Connection destroyed");t.code=r.ERR_CONNECTION_DESTROYED,o(t)})}),destroy:h}};exports.default=s,module.exports=exports.default;
},{"./constants":"oE8C","./errorCodes":"dJki","./createDestructor":"1j7A","./getOriginFromSrc":"Q/di","./createLogger":"fuGz","./connectCallReceiver":"y9tl","./connectCallSender":"u45o"}],"DSb+":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.loadIframe=exports.ERROR_CODES=void 0;var e=t(require("penpal/lib/connectToChild")),o=require("penpal/lib/errorCodes");function t(e){return e&&e.__esModule?e:{default:e}}var n=1e4,i=1e4,r=2e3,u=function(){},s={CONNECTION_TIMEOUT:"connectionTimeout",RENDER_TIMEOUT:"renderTimeout",EXTENSION_RESPONSE_TIMEOUT:"extensionResponseTimeout",DESTROYED:"destroyed"};exports.ERROR_CODES=s;var E=function(t){var E,T=t.iframe,a=t.extensionInitOptions,c=void 0===a?{}:a,d=t.connectionTimeoutDuration,m=void 0===d?n:d,p=t.renderTimeoutDuration,O=void 0===p?r:p,f=t.extensionResponseTimeoutDuration,l=void 0===f?i:f,R=t.openCodeEditor,v=void 0===R?u:R,N=t.openRegexTester,_=void 0===N?u:N,I=t.openDataElementSelector,S=void 0===I?u:I,D=t.markAsDirty,C=void 0===D?u:D,x=t.debug,M=void 0!==x&&x,P=function(e){return function(){return Promise.resolve(e.apply(void 0,arguments))}};return{promise:new Promise(function(t,n){var i,r=(0,e.default)({iframe:T,timeout:m,methods:{openCodeEditor:P(v),openRegexTester:P(_),openDataElementSelector:P(S),extensionRegistered:function(){r.promise.then(function(e){e.init(c).then(function(){clearTimeout(i),t({init:e.init,validate:function(){return Promise.race([new Promise(function(e,o){setTimeout(function(){o(s.EXTENSION_RESPONSE_TIMEOUT)},l)}),e.validate.apply(e,arguments)])},getSettings:function(){return Promise.race([new Promise(function(e,o){setTimeout(function(){o(s.EXTENSION_RESPONSE_TIMEOUT)},l)}),e.getSettings.apply(e,arguments)])}})}).catch(function(e){clearTimeout(i),n(e)})})},markAsDirty:C},debug:M});r.promise.then(function(){i=setTimeout(function(){n(s.RENDER_TIMEOUT),E()},O)},function(e){e.code===o.ERR_CONNECTION_TIMEOUT?n(s.CONNECTION_TIMEOUT):n(e)}),E=function(){n(s.DESTROYED),r.destroy()}}),destroy:E}};exports.loadIframe=E;
},{"penpal/lib/connectToChild":"TAMi","penpal/lib/errorCodes":"dJki"}],"tmkU":[function(require,module,exports) {
module.exports=function(){return Promise.resolve("Edited Code "+Math.round(1e4*Math.random()))};
},{}],"OQM1":[function(require,module,exports) {
module.exports=function(){return Promise.resolve("Edited Regex "+Math.round(1e4*Math.random()))};
},{}],"QD6G":[function(require,module,exports) {
module.exports=function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e="dataElement"+Math.round(1e4*Math.random());return!1!==t.tokenize&&(e="%".concat(e,"%")),e};
},{}],"SA8s":[function(require,module,exports) {
"use strict";var e,o=require("@adobe/reactor-bridge"),t=i(require("./openCodeEditor")),n=i(require("./openRegexTester")),r=i(require("./openDataElementSelector"));function i(e){return e&&e.__esModule?e:{default:e}}var a=document.getElementById("extensionViewIframe");module.exports=function(i){var d=i.viewPath,c=i.initInfo,s=i.openCodeEditor,u=void 0===s?t.default:s,l=i.openRegexTester,f=void 0===l?n.default:l,p=i.openDataElementSelector,m=void 0===p?r.default:p;return e&&e.destroy(),a.src=d?"extensionViews/".concat(extensionDescriptor.name,"/").concat(extensionDescriptor.version,"/").concat(d):"noConfigIframe.html",(e=(0,o.loadIframe)({iframe:a,extensionInitOptions:c,openCodeEditor:u,openRegexTester:f,openDataElementSelector:m})).promise.catch(function(e){if(e!==o.ERROR_CODES.DESTROYED)throw e})};
},{"@adobe/reactor-bridge":"DSb+","./openCodeEditor":"tmkU","./openRegexTester":"OQM1","./openDataElementSelector":"QD6G"}],"vTE5":[function(require,module,exports) {
...
},{}],"BxXb":[function(require,module,exports) {
"use strict";var e=a(require("ajv")),t=a(require("split.js")),n=a(require("deep-equal")),i=a(require("./loadExtensionView"));function a(e){return e&&e.__esModule?e:{default:e}}var o={CONFIGURATION:"configuration",EVENTS:"events",CONDITIONS:"conditions",ACTIONS:"actions",DATA_ELEMENTS:"dataElements"},r=[{value:o.CONFIGURATION,label:"Extension Configuration"},{value:o.EVENTS,label:"Events"},{value:o.CONDITIONS,label:"Conditions"},{value:o.ACTIONS,label:"Actions"},{value:o.DATA_ELEMENTS,label:"Data Elements"}],s="--N/A--",c="Other",l={lineNumbers:!0,mode:"application/json",gutters:["CodeMirror-lint-markers"],lint:!0,value:"{}",extraKeys:{Tab:function(e){e.replaceSelection("  ","end")}}},d=function(e){return e.innerHTML=""},u=function(e){var t={};return e&&e.forEach(function(e){var n=e.categoryName||s;t[n]||(t[n]=[]),t[n].push(e)}),Object.keys(t).forEach(function(e){t[e].sort(function(e,t){return e.displayName<t.displayName?-1:e.displayName>t.displayName?1:0})}),t},m=function(e){throw alert("An error has occurred. Please see the browser console."),e};extensionDescriptor.platform&&"web"===extensionDescriptor.platform||(document.querySelector('[href="libSandbox.html"]').style.display="none");var f,g=document.getElementById("viewGroupSelector"),p=document.getElementById("extensionViewSelector"),v=document.getElementById("validateButton"),h=document.getElementById("validateOutput"),I=CodeMirror(document.getElementById("initEditorContainer"),l),S=document.getElementById("initButton"),E=document.getElementById("resetInitButton"),b=document.getElementById("tabsIndicator"),y=CodeMirror(document.getElementById("getSettingsEditorContainer"),l),N=document.getElementById("getSettingsButton"),x=document.getElementById("copySettingsToInitButton"),O=document.getElementById("extensionViewPane"),A=localStorage.getItem("lastSelectedView"),T=localStorage.getItem("lastSelectedViewGroup"),C=function(){d(p);var e=g.value;localStorage.setItem("lastSelectedViewGroup",e);var t=u(extensionDescriptor[e]);Object.keys(t).sort(function(e,t){for(var n=[s,c],i=0;i<n.length;i++)if(e===n[i]||t===n[i])return e===n[i]?1:-1;return e<t?-1:e>t?1:0}).forEach(function(e){var n;e!==s?((n=document.createElement("optgroup")).label=e,p.appendChild(n)):n=p,t[e].forEach(function(e){var t=document.createElement("option");t.value=e.viewPath||"",t.text=e.displayName,t.descriptor=e,t.selected=e.name===A,n.appendChild(t)})}),e===o.CONFIGURATION?p.setAttribute("hidden","hidden"):p.removeAttribute("hidden")},w=function(){if(-1!==g.selectedIndex)return g.options[g.selectedIndex].value},B=function(){if(-1!==p.selectedIndex){var e=p.options[p.selectedIndex];return localStorage.setItem("lastSelectedView",e.descriptor.name),e.value}},L=function(){var e=j();return e&&e.viewPath?"".concat(extensionDescriptor.name,"/").concat(extensionDescriptor.version,"/").concat(e.viewPath):null},V=function(e){I.setValue(JSON.stringify(e,null,2))},D=function(){y.setValue("{}")},k=function(){h.innerHTML=""},M=function(){var e=j(),t={settings:null};return w()!==o.CONFIGURATION&&(t.extensionSettings={foo:"bar"}),t.propertySettings={domains:["adobe.com","example.com"],linkDelay:100,trackingCookieName:"sat_track",undefinedVarsReturnEmpty:!1},t.tokens={imsAccess:"X34DF56GHHBBFFGH"},t.company={orgId:"ABCDEFGHIJKLMNOPQRSTUVWX@AdobeOrg"},t.schema=e?e.schema:null,t},G=function(){var e,t=B(),a=M(),o=U();o&&!(0,n.default)(o,a)?(e=o,E.disabled=!1,E.removeAttribute("disabled")):(e=a,E.disabled=!0,E.setAttribute("disabled","disabled")),V(e),D(),k(),(0,i.default)({viewPath:t,initInfo:e}).then(function(e){return f=e}).catch(m)},j=function(){if(-1!==p.selectedIndex)return p.options[p.selectedIndex].descriptor},q=function(e){return fetch(e).then(function(e){return e.json()})},P=function(){v.disabled=!0,v.textContent="Awaiting validation...",f.validate().then(function(t){if(t){var n=j();if(n&&n.schema)return f.getSettings().then(function(t){var i=(0,e.default)({loadSchema:q,schemaId:"auto"});i.addMetaSchema(require("ajv/lib/refs/json-schema-draft-04.json")),i.compileAsync(n.schema).then(function(e){var n=e(t);h.innerHTML=n?"Valid":'<span class="error">Settings object does not match schema</span>'})});h.innerHTML='<span class="error">Schema not defined</span>'}else h.innerHTML="Invalid"}).catch(m).finally(function(){v.disabled=!1,v.textContent="Validate"})},H=function(){N.disabled=!0,x.disabled=!0,N.textContent="Awaiting settings...",f.getSettings().then(function(e){y.setValue(JSON.stringify(e,null,2))}).catch(m).finally(function(){N.disabled=!1,x.disabled=!1,N.textContent="Get Settings"})},J=function(){f.getSettings().then(function(e){var t;try{t=JSON.parse(I.getValue())}catch(n){alert("Unable to copy settings to init panel. Init panel contents is not valid JSON.")}t.settings=e,V(t)}).catch(m)},F=function(){var e=JSON.parse(I.getValue()),t=M();(0,n.default)(e,t)||(_(e),E.disabled=!1),f.init(e).catch(m)},R=function(){var e=M();_(null),V(e),E.disabled=!0,f.init(e).catch(m)},U=function(){var e=JSON.parse(localStorage.getItem("initInfo")||"{}"),t=L();return t?e[t]:null},_=function(e){var t=JSON.parse(localStorage.getItem("initInfo")||"{}"),n=L();n&&(t[n]=e,localStorage.setItem("initInfo",JSON.stringify(t)))};extensionDescriptor.configuration&&(extensionDescriptor.configuration=[extensionDescriptor.configuration]),r.forEach(function(e){var t=extensionDescriptor[e.value];if(t&&t.length){var n=document.createElement("option");n.value=e.value,n.text=e.label,n.selected=e.value===T,g.appendChild(n)}}),C(),g.addEventListener("change",function(){C(),G()}),v.addEventListener("click",P),N.addEventListener("click",H),x.addEventListener("click",J),S.addEventListener("click",F),E.addEventListener("click",R),p.addEventListener("change",G),(0,t.default)(["#extensionViewPane","#controlPane"],{minSize:0,sizes:[65,35]}),G(),document.querySelector(".spectrum-Tabs").addEventListener("click",function(e){e.target.hasAttribute("data-panel-id")&&(document.querySelector(".spectrum-Tabs-item.is-selected").classList.remove("is-selected"),document.querySelector(".spectrum-Panel.is-selected").classList.remove("is-selected"),e.target.parentNode.classList.add("is-selected"),document.getElementById(e.target.dataset.panelId).classList.add("is-selected"),b.setAttribute("style",e.target.dataset.panelStyle),setTimeout(function(){I.refresh(),y.refresh()},50))}),window.loadExtensionView=i.default;
},{"ajv":"YYGk","split.js":"zDnq","deep-equal":"I4Ai","./loadExtensionView":"SA8s","ajv/lib/refs/json-schema-draft-04.json":"vTE5"}]},{},["BxXb"], null)
//# sourceMappingURL=/viewSandbox.js.map